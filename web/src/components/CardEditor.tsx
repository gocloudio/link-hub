...
import { clearDraft, draftKey, type Draft } from "@/lib/card-draft";
import { CardSharingFields } from "./cards/CardSharingFields";
export { clearDraft, readDraft, draftKey, type Draft } from "@/lib/card-draft";
          ...
          <form className="drawer-layout" onSubmit={save} noValidate>
            ...
            <div className="drawer-body">
              ...
              <p className="field-hint">
                支持文字、列表、链接和代码。保存后可通过“查看说明”阅读完整内容。
              </p>
              {error && (
